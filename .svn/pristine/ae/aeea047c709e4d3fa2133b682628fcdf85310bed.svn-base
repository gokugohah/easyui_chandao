...
public class JavaMail {
    ...
    public void doSendHtmlEmail(String subject, String sendHtml,
        ...
        try {
            ...
            InternetAddress from = new InternetAddress(MimeUtility.encodeWord("猜猜我是谁")+" <"+sender_username+">");
    ...
    /*public static void main(String[] args) {
		...
		jm.doSendHtmlEmail("懵逼......", "也不知道发没发过去", "649755137@qq.com");
	}*/
